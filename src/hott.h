...
typedef struct {
  ...
  uint16_t baroAltitude;           /* Byte 22: 243 244 = /Baro Altitude 500 = 0m */
  uint16_t baroClimbRate;          /* Byte 24: 48 = Baro vertical velocity m/s resolution 0.01m 48 = 30000 = 0.00m/s (1=0.01m/s) */
  ...
  uint8_t timeHours;               /* Byte 33 GPS time hours */
  uint8_t timeMinutes;             /* Byte 34 GPS time minutes */
  uint8_t timeSeconds;             /* Byte 35 GPS time seconds */
  uint8_t timeHundreds;            /* Byte 36 GPS time 1/100 seconds */
  uint16_t GPSaltitude;            /* Byte 37: GPS Alt (MSL) */
